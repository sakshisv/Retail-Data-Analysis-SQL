...
select Age, total_amt from(
select DATEDIFF(YEAR, b.DOB, a.tran_date) Age, a.total_amt from Transactions a
inner join Customer b
on a.cust_id = b.customer_Id
group by b.DOB, a.tran_date, a.total_amt
having tran_date >= DATEADD(DAY, -30, MAX(a.tran_date))) x
...
on a.cust_id = b.customer_Id
group by b.DOB, a.tran_date, a.total_amt
having a.tran_date BETWEEN DATEADD(DAY, -30, MAX(a.tran_date)) AND MAX(a.tran_date)
