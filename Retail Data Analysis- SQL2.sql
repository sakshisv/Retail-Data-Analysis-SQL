...
select sum(total_amt) Total_Revenue from (
select DATEDIFF(YEAR, convert(date, b.DOB), GETDATE()) Age, a.total_amt from Transactions a
inner join Customer b
on a.cust_id = b.customer_Id
group by a.tran_date, b.DOB, a.total_amt
having a.tran_date BETWEEN DATEADD(DAY, -30, MAX(a.tran_date)) and MAX(a.tran_date)) x
